...
<body id="back">
    ...
    <div class="container" style="margin-top: 40px;">
        <main class="container" id="contact">
            <form id="contact" action="<%=request.getContextPath() %>/administrador?action=cadastrarProfessor" method="POST">
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="email" name="email" placeholder="nome@dominio.com" required>
                    </div>
                    <!-- F Definindo Uma informação -->
                    <!-- I Definindo Uma informação -->
                    <div class="form-group col-md-6">
